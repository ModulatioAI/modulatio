...
# ── record() atomicity under shared wave workers (resweep fold) ─────────────
# One tracker is deliberately shared across concurrent wave workers (the
# ContextVar BINDING is copied, not the object); the += accumulation was a
# non-atomic RMW that lost increments and under-counted spend.
